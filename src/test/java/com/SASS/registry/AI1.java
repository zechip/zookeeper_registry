...
public class AI1 {
    @Test
    public void registry_ai1() throws IOException, InterruptedException, KeeperException {
        ...
        registry.initPaths();
        registry.registerService("AI-1", "192.168.1.100", 8080, List.of("101","102"), 5, 20, 30);
        while (true) {
            Thread.sleep(1000);
        }
    }
