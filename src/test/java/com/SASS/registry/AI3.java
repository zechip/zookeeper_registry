...
public class AI3 {
    @Test
    public void registry_ai3() throws IOException, InterruptedException, KeeperException {
        ...
        registry.initPaths();
        registry.registerService("AI-3", "192.168.3.100", 8080, List.of("102", "105"), 5, 20, 30);
        while (true) {
            Thread.sleep(1000);
        }
    }
